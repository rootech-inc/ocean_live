    ...
    try:
        ...
        if method == 'PUT':
            ...
            # save job card
                ...
                success_response['message'] = just_service_card.pk
        ...
        # read data
            ...
            if module == 'services':
                ...
                query = ServiceCard.objects.filter(
                    ...
                    Q(app__provider__id=prov) if prov != '*' else Q()
                ...
                for service in query:
                    if doc == 'preview':
                        ...
                        sheet[f"B{sheet_count}"] = f"{service.app.name} {service.ticket.title}"
        ...
        # delete data
            ...
            elif module == 'delete_job_card':
                cardno = data.get('cardno')
                ServiceCard.objects.filter(cardno=cardno).delete()
                success_response['message'] = f"{cardno} has been deleted"
