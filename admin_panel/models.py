...
class MailQueues(models.Model):
    ...
    mail_key = models.CharField(max_length=65,null=False,unique=True)
...
class TransferHD(models.Model):
    ...
    is_sent = models.BooleanField(default=False) # 1
    ...
    reccieved_by = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL,null=True,related_name="transfer_recieved_by") #2
