    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(max_length=3, unique=True)),
                ('descr', models.TextField()),
                ('type', models.CharField(default='retail', max_length=10)),
                ('server_location', models.TextField(null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mail_key', models.CharField(max_length=65, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(upload_to='static/uploads/bsms/2025-04-07_11-54-10')),
                ('message', models.TextField()),
                ('created_date', models.DateField(auto_now_add=True)),
                ('created_time', models.TimeField(auto_now=True)),
                ('status', models.IntegerField(default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transfer_hd_created_by', to=settings.AUTH_USER_MODEL)),
                ('loc_fr', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transfer_location_from', to='admin_panel.locations')),
                ('loc_to', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transfer_location_to', to='admin_panel.locations')),
                ('reccieved_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='transfer_recieved_by', to=settings.AUTH_USER_MODEL)),
                ('sent_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='transfer_sent_by', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='TransferTran',
            fields=[
                ...
                ('line', models.IntegerField()),
                ('packing', models.TextField()),
                ('pack_qty', models.DecimalField(decimal_places=2, default=0.0, max_digits=65)),
                ('tran_qty', models.DecimalField(decimal_places=2, max_digits=65)),
